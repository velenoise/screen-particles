...
module.exports = function( exports )
{
    ...
    exports.init = function( width, height, renderer, simulationMaterial, renderMaterial, debugObject ){
        ...
        if (debugObject) debugObject.material.map = rtt.texture;
        ...
        for ( var i = 0; i < l; i++ ) {
            ...
            vertices[ i3 + 1 ] = 1. - ( i / width ) / height;

            uvs[i * 2] = (i % width) / width;
            uvs[i * 2 + 1] = (i / width) / height;
        }
